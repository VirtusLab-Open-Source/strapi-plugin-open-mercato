...
We use [GitHub Issues](https://github.com/sensinum-lab/strapi-plugins/issues) to track public bugs. Before creating a new issue, please check if your problem has already been reported.
